...
mod tests {
    ...
    fn test_point_add_point() {
        ...
        p1.add_point(&p2);
        assert_eq!(p1, Point::new(5.0, 7.0, 9.0));
    }
    ...
    fn test_point_subtract_point() {
        ...
        assert_eq!(p1, Point::new(3.0, 3.0, 3.0));
    }
    ...
    fn test_point_set() {
        ...
        p.set(9.0, 8.0, 7.0);
        assert_eq!(p, Point::new(9.0, 8.0, 7.0));
    }
    ...
    fn test_vec3_subtract_vector() {
        let mut v1 = Vec3::new(5.0, 6.0, 7.0);
    ...
    fn test_vec3_to_point() {
        ...
        let p = v.to_point();
        assert_eq!(p, Point::new(1.1, 2.2, 3.3));
    }
